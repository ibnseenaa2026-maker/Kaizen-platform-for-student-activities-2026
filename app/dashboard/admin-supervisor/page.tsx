      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-200 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-4 text-center md:text-right">
            ...
            {/* 🛡️ الشعار المعتمد تماماً كاللوحات الأخرى في التطبيق */}
            <div className="w-16 h-16 rounded-2xl overflow-hidden shadow-sm border border-gray-200 bg-white flex items-center justify-center flex-shrink-0">
              <img 
                src="/logo.png" 
                alt="شعار المدرسة" 
